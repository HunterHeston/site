  ...
  return (
    <div>
      <div className="flex min-h-screen w-screen flex-col items-center bg-zinc-50 duration-300 dark:bg-zinc-950">
        <div className="flex min-h-screen w-screen flex-col bg-white duration-300 dark:bg-zinc-900 dark:text-white md:w-5/6 md:px-5">
          ...
          <div className="flex-grow">
            <Navigation>
              <Link
                ...
                className={
                  "group flex items-center rounded-full bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-2 text-sm font-medium  transition duration-300 hover:from-blue-600 hover:to-purple-800 "
                }
              >
                Resume
              </Link>
